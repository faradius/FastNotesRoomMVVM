...
import com.developerscracks.fastnotes.data.datastore.SettingsDataStore
import com.developerscracks.fastnotes.domain.utils.DataStoreKeys.Companion.DARK_MODE_KEY
import com.developerscracks.fastnotes.domain.utils.DataStoreKeys.Companion.LAYOUT_MODE_KEY
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.catch
import kotlinx.coroutines.flow.map
import java.io.IOException

const val SETTINGS_PREFERENCES_NAME: String = "settings_preferences"

class SettingsRepository(val context: Application) : SettingsDataStore {
