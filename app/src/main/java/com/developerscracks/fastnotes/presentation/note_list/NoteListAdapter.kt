...
import com.developerscracks.fastnotes.databinding.LayoutNoteItemBinding
...
class NoteListAdapter : ListAdapter<Note, NoteListAdapter.NoteViewHolder>(NoteDiffUtil) {
    ...
    inner class NoteViewHolder(
        ...
        private val title = itemBinding.tvNoteTitle
        private val content = itemBinding.tvNoteContent

        //Esto es para acceder al archivo note_background y poder modificar el atributo stroke
